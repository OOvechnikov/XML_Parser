...
public class Person {
    ...
    private static final DateFormat formatter = new SimpleDateFormat("dd-MMM-yyyy", Locale.ENGLISH);
    ...
    public String toString() {
        return getName() + " " + (getSex().equals(Sex.MALE) ? "м" : "ж") + " " + formatter.format(getBirthDate());
    }
}
